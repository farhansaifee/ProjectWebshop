...

{
    ...
    $update_customer = "update customers set
     customer_name='$c_name' , customer_email='$c_email', customer_country = '$c_country' , customer_city='$c_city',customer_address='$c_address'
     ...
     if($run_customer)
     {
         echo "<script>alert('Your account has benn edited , to complete the process , please Relogin')</script>";
